...
@Table(name = "cat_conceptos_cri", schema = "siox")
public class CatConceptosCri {
    public CatConceptosCri() {
        // Constructor vacío requerido por Hibernate
    }

    public CatConceptosCri(String clave, String nombre, String descripcion, Integer idClase, String claveCompuesta,
